...
async function addMongoFiles() {
  await util.getUrl2File('model/index-mongo.js', util.combilePath('model/index.js'));
  await util.getUrl2File('common/mongoDao.js', util.combilePath('common/mongoDao.js'));
  await util.getUrl2File('common/mongoGridFsDao.js', util.combilePath('common/mongoGridFsDao.js'));
